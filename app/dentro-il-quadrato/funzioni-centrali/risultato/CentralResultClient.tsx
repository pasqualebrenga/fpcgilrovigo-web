...
export default function CentralResultClient() {
  ...
  async function share() {
    const data = {
      title: "Dentro il Quadrato - Funzioni centrali",
  ...
  return (
    <main className="dentroQuadratoShell result-page central-result">
      <section className="result-head">
        ...
        <div className="result-actions">
          <Link href="/dentro-il-quadrato/funzioni-centrali">← Modifica dati</Link>
