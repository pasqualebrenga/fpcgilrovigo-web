...
export default function RisultatoClient() {
  ...
  async function share() {
    const data = {
      ...
      text: `Il mio incremento fisso CCNL 2025-2027: ${money.format(aumentoComplessivoMese)} lordi al mese da luglio 2027.`,
  ...
  return (
    <main className="dentroQuadratoShell result-page">
      <section className="result-head">
        ...
        <div className="result-actions">
          <Link href="/dentro-il-quadrato/funzioni-locali">← Modifica dati</Link>
