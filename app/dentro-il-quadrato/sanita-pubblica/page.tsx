...
export default function HealthHomePage() {
  ...
  function calculate(event: React.FormEvent) {
    ...
    router.push(`/dentro-il-quadrato/sanita-pubblica/risultato?area=${area}&livello=${encodeURIComponent(level)}&nuoviDep=${newDeps}&indennita=${allowance}&ore=${weeklyHours}`);
  }

  return (
    <main className="dentroQuadratoShell health-page">
