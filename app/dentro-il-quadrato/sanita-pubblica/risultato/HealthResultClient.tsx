...
export default function HealthResultClient() {
  ...
  async function share() {
    const data = {
      title: "Dentro il Quadrato - Sanità",
      text: `Il mio aumento CCNL Sanità 2025-2027: ${money.format(monthlyTotal)} lordi al mese.`,
  ...
  return (
    <main className="dentroQuadratoShell result-page health-result">
      <section className="result-head">
        ...
        <div className="result-actions">
          <Link href="/dentro-il-quadrato/sanita-pubblica">← Modifica dati</Link>
